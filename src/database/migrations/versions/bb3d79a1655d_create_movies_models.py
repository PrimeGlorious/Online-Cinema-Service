...
Revision ID: bb3d79a1655d
Revises: 41cdafa531cf
Create Date: 2025-06-06 10:56:37.488017
...
def upgrade() -> None:
    ...
    op.add_column('movies', sa.Column('uuid', sa.String(length=255), nullable=False))
...
def downgrade() -> None:
    ...
    op.create_foreign_key('movies_country_id_fkey', 'movies', 'countries', ['country_id'], ['id'])
    op.drop_constraint(None, 'movies', type_='unique')
    op.drop_constraint('unique_movie_constraint', 'movies', type_='unique')
    op.create_unique_constraint('unique_movie_constraint', 'movies', ['name', 'date'])
    ...
    sa.ForeignKeyConstraint(['language_id'], ['languages.id'], name='movies_languages_language_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['movie_id'], ['movies.id'], name='movies_languages_movie_id_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('movie_id', 'language_id', name='movies_languages_pkey')
    )
    op.create_table('actors_movies',
    sa.Column('movie_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('actor_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['actor_id'], ['actors.id'], name='actors_movies_actor_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['movie_id'], ['movies.id'], name='actors_movies_movie_id_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('movie_id', 'actor_id', name='actors_movies_pkey')
    )
    ...
    sa.UniqueConstraint('code', name='countries_code_key'),
    postgresql_ignore_search_path=False
    )
    op.create_table('movies_genres',
    sa.Column('movie_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('genre_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['genre_id'], ['genres.id'], name='movies_genres_genre_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['movie_id'], ['movies.id'], name='movies_genres_movie_id_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('movie_id', 'genre_id', name='movies_genres_pkey')
    )
